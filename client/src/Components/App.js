...
function App() {
    ...
    //useEffect(() => {setPickedItems(pickedItems);}, []);
        ...
        <Content>
          <ContentLeft id='toHide'>
            ...
            <ContentLeftBottom>
              ...
              <Results ref={resultsRef} openBurger={openBurger} currentList={currentList} searchResults={searchResults} pickedItems={pickedItems} onCheck={changeNumberInput} />
            </ContentLeftBottom>
          </ContentLeft>
          <ContentRight>
